...
cond_sub_correct_48_new[67,] = c("4",1,"Unrelated", 0 )
cond_sub_correct_48_new[68,] = c("13",1,"Unrelated", 0 )
...
```{r}
library(Rmisc)
immediateagg_rmisc_48_new = summarySE(prime_subject_acc_48_new,
                      measurevar = "ImmediateAccuracy",
                      groupvars = c("PrimeCondition"))
...
```{r}
library(Rmisc)
delayedagg_rmisc_48_new = summarySE(prime_subject_acc_48_new,
                      measurevar = "DelayedAccuracy",
                      groupvars = c("PrimeCondition"))
#DELAYED
