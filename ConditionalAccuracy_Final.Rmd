...
prime_acc_48 = group_by(memory48, PrimeCondition) %>%
  summarise_at(vars(ImmediateAccuracy, DelayedAccuracy,
                    RTImmediate, RTDelayed,
                    PrimeIntrusionImmediate, PrimeIntrusionDelayed), mean)

prime_subject_acc_48 = group_by(memory48, Subject, PrimeCondition) %>%
  summarise_at(vars(ImmediateAccuracy, DelayedAccuracy,
                    PrimeIntrusionImmediate, PrimeIntrusionDelayed), mean)

prime_ident_48 = prime_subject_acc_48 %>%
    filter(PrimeCondition == "Identical")
...
prime_ident_48_new = prime_subject_acc_48_new %>%
    filter(PrimeCondition == "Identical")
```
...
target_p = prime_subject_acc_48_new %>% filter(PrimeCondition == "Phonological")
target_r = prime_subject_acc_48_new %>% filter(PrimeCondition == "Semantic")
target_i = prime_subject_acc_48_new %>% filter(PrimeCondition == "Identical")
target_u = prime_subject_acc_48_new %>% filter(PrimeCondition == "Unrelated")

t.test(target_i$ImmediateAccuracy, target_r$ImmediateAccuracy, paired = TRUE)
t.test(target_i$ImmediateAccuracy, target_p$ImmediateAccuracy, paired = TRUE)
t.test(target_i$ImmediateAccuracy, target_u$ImmediateAccuracy, paired = TRUE)

t.test(target_p$ImmediateAccuracy, target_r$ImmediateAccuracy, paired = TRUE)
t.test(target_p$ImmediateAccuracy, target_u$ImmediateAccuracy, paired = TRUE)
t.test(target_r$ImmediateAccuracy, target_u$ImmediateAccuracy, paired = TRUE)
```
...
cond_sub_correct_48_new[127,] = c("4",1,"Unrelated", 0 )
cond_sub_correct_48_new[128,] = c("13",1,"Unrelated", 0 )

## We can do a simple ANOVA at this point
cond_sub_correct_48_new$Subject = as.factor(cond_sub_correct_48_new$Subject)
cond_sub_correct_48_new$DelayedAccuracy = as.numeric(cond_sub_correct_48_new$DelayedAccuracy)
cond_sub_correct_48_new = as.data.frame(cond_sub_correct_48_new)
...
target_p = cond_sub_correct_48_new %>% filter(PrimeCondition == "Phonological")
target_r = cond_sub_correct_48_new %>% filter(PrimeCondition == "Semantic")
target_i = cond_sub_correct_48_new %>% filter(PrimeCondition == "Identical")
target_u = cond_sub_correct_48_new %>% filter(PrimeCondition == "Unrelated")

t.test(target_i$DelayedAccuracy, target_r$DelayedAccuracy, paired = TRUE)
t.test(target_i$DelayedAccuracy, target_p$DelayedAccuracy, paired = TRUE)
t.test(target_i$DelayedAccuracy, target_u$DelayedAccuracy, paired = TRUE)

t.test(target_p$DelayedAccuracy, target_r$DelayedAccuracy, paired = TRUE)
t.test(target_p$DelayedAccuracy, target_u$DelayedAccuracy, paired = TRUE)
t.test(target_r$DelayedAccuracy, target_u$DelayedAccuracy, paired = TRUE)
```
...
## We can do a simple ANOVA at this point
cond_sub_correct_500$Subject = as.factor(cond_sub_correct_500$Subject)
cond_sub_correct_500$DelayedAccuracy = as.numeric(cond_sub_correct_500$DelayedAccuracy)
cond_sub_correct_500 = as.data.frame(cond_sub_correct_500)
cond_sub_correct_500_aov = aov(data = cond_sub_correct_500, 
                      DelayedAccuracy ~ PrimeCondition + 
                  Error(Subject/(PrimeCondition)))
summary(cond_sub_correct_500_aov)

library(multcomp)
library(knitr)
options(contrasts = c('contr.sum', 'contr.poly'))

conditional_lsm = lsmeans::lsmeans(cond_sub_correct_500_aov, c("PrimeCondition"))
prime_effect = cld(conditional_lsm, alpha = 0.05, 
                adjust = "tukey", details = TRUE)
kable(subset(prime_effect$comparisons,prime_effect$comparisons$p.value < 0.05 ))


target_p = cond_sub_correct_500 %>% filter(PrimeCondition == "Phonological")
target_r = cond_sub_correct_500 %>% filter(PrimeCondition == "Semantic")
target_i = cond_sub_correct_500 %>% filter(PrimeCondition == "Identical")
target_u = cond_sub_correct_500 %>% filter(PrimeCondition == "UnSemantic")
target_n = cond_sub_correct_500 %>% filter(PrimeCondition == "Neutral")

t.test(target_i$DelayedAccuracy, target_r$DelayedAccuracy, paired = TRUE)
t.test(target_i$DelayedAccuracy, target_p$DelayedAccuracy, paired = TRUE)
t.test(target_i$DelayedAccuracy, target_u$DelayedAccuracy, paired = TRUE)
t.test(target_i$DelayedAccuracy, target_n$DelayedAccuracy, paired = TRUE)

t.test(target_r$DelayedAccuracy, target_p$DelayedAccuracy, paired = TRUE)
t.test(target_r$DelayedAccuracy, target_u$DelayedAccuracy, paired = TRUE)
t.test(target_r$DelayedAccuracy, target_n$DelayedAccuracy, paired = TRUE)
```
...
z_RT_48new_imm [127,] = c("4", "Unrelated", -0.00402, 1544 )
z_RT_48new_imm [128,] = c("13", "Unrelated", -0.00402, 1544 )


## 9 missing cells in Delayed
## S11 P, S13 P, S13 U, S14 Sem, S4 U, S9 Sem
z_RT_48new_del [120,] = c("13", "Phonological", -0.0466, 1403)
z_RT_48new_del [121,] = c("13", "Unrelated", 0.0653, 1516)
z_RT_48new_del [122,] = c("11", "Phonological", -0.0466, 1403)
z_RT_48new_del [123,] = c("14", "Semantic", -0.00625, 1452)
z_RT_48new_del [124,] = c("4", "Unrelated", 0.0653, 1516)
z_RT_48new_del [125,] = c("9", "Semantic", -0.00625, 1452)
z_RT_48new_del [126,] = c("21", "Unrelated", 0.0653, 1516)
z_RT_48new_del [127,] = c("24", "Identical", -0.0152, 1439)
z_RT_48new_del [128,] = c("24", "Unrelated", 0.0653, 1516)
...
# Prime Intrusion Rates

## Immediate

```{r}
intrusion_48 = Rmisc::summarySE(prime_subject_acc_48, 
                      measurevar = "PrimeIntrusionImmediate",
                      groupvars = c("PrimeCondition"))
intrusion_48_new = Rmisc::summarySE(prime_subject_acc_48_new, 
                      measurevar = "PrimeIntrusionImmediate",
                      groupvars = c("PrimeCondition"))
...
library(ggthemes)
intrusion_48 %>% 
  mutate(PrimeCondition = factor(PrimeCondition, 
                        levels = unique(PrimeCondition),
                    labels = c("Identical", "Neutral", 
                               "Phonological", "Semantic", "Unrelated")))%>%
ggplot(aes(x = PrimeCondition, y = PrimeIntrusionImmediate))+
 geom_bar(stat = "identity", position = "dodge", width = 0.5, fill = "darkgreen")+
  geom_errorbar(aes(ymin = PrimeIntrusionImmediate - ci, ymax = PrimeIntrusionImmediate + ci),
                width=.05, position=position_dodge(.5)) +
  theme_few()+
  xlab("Prime Condition") + ylab("Mean Intrusion Rate") + 
  ggtitle("48 ms: Immediate: Mean Intrusion by Prime Condition")
...
ggplot(aes(x = PrimeCondition, y = PrimeIntrusionImmediate))+
 geom_bar(stat = "identity", position = "dodge", width = 0.5, fill = "darkgreen")+
  ...
  theme_few()+
  xlab("Prime Condition") + ylab("Mean Intrusion Rate") + 
  ggtitle("48 ms NEW: Immediate: Mean Intrusion by Prime Condition")
...
```{r}
intrusion_48 = Rmisc::summarySE(prime_subject_acc_48, 
                      measurevar = "PrimeIntrusionDelayed",
                      groupvars = c("PrimeCondition"))
intrusion_48_new = Rmisc::summarySE(prime_subject_acc_48_new, 
                      measurevar = "PrimeIntrusionDelayed",
                      groupvars = c("PrimeCondition"))
...
intrusion_48 %>% 
  mutate(PrimeCondition = factor(PrimeCondition, 
                    ...
                    labels = c("Identical", "Neutral", 
                               "Phonological", "Semantic", "Unrelated")))%>%
ggplot(aes(x = PrimeCondition, y = PrimeIntrusionDelayed))+
 geom_bar(stat = "identity", position = "dodge", width = 0.5, fill = "darkgreen")+
  geom_errorbar(aes(ymin = PrimeIntrusionDelayed - ci, ymax = PrimeIntrusionDelayed + ci),
                width=.05, position=position_dodge(.5)) +
  theme_few()+
  xlab("Prime Condition") + ylab("Mean Intrusion Rate") + 
  ggtitle("48 ms: Delayed: Mean Intrusion by Prime Condition")
...
ggplot(aes(x = PrimeCondition, y = PrimeIntrusionDelayed))+
 geom_bar(stat = "identity", position = "dodge", width = 0.5, fill = "darkgreen")+
  ...
  theme_few()+
  xlab("Prime Condition") + ylab("Mean Intrusion Rate") + 
  ggtitle("48 ms NEW: Delayed: Mean Intrusion by Prime Condition")
```

# Accuracy in Identical Condition

```{r}
hist(prime_ident_48$ImmediateAccuracy, main = "48 ms 20-min delay")
hist(prime_ident_48_new$ImmediateAccuracy, main = "48 ms 2-day delay")
